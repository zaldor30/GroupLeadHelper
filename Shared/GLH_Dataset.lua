...
function ds:GetBuffs()
    return {
        ...
        [2] = { id = 462854, name = 'Skyfury', icon = C_Spell.GetSpellTexture(462854), count = 0, iconFrame = nil, class = {['SHAMAN'] = true} },
        [3] = { id = 1459, name = 'Arcane Intellect', icon = C_Spell.GetSpellTexture(1459), iconFrame = nil, count = 0, class = {['MAGE'] = true} },
        [4] = { id = 21562, name = 'Power Word: Fortitude', icon = C_Spell.GetSpellTexture(21562), iconFrame = nil, count = 0, class = {['PRIEST'] = true} },
        [5] = { id = 1126, name = 'Mark of the Wild', icon = C_Spell.GetSpellTexture(1126), count = 0, iconFrame = nil, class = {['DRUID'] = true} },
        [6] = { id = 381748, name = 'Blessing of the Bronze', icon = C_Spell.GetSpellTexture(381748), count = 0, iconFrame = nil, class = {['EVOKER'] = true} },
    }
end
