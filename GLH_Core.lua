...
local function eventsPLAYER_LOGIN() core:StartGroupLeadHelper() end
...
function core:StartDatabase()
    ...
    ns.ds:Init() -- Initialize Buff Tables and Sorted
end
...
function GLH:OnInitialize() --* Called when the addon is loaded
    GLH:RegisterEvent('PLAYER_LOGIN', eventsPLAYER_LOGIN)
end